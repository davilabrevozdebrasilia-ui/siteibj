...
export default function ImagemFormComponent({ form, setForm, handleFileChange, onSubmit }: Props) {
    return (
        <form className="flex flex-col gap-4">
            ...
            {form.url && (
                <img src={form.url} className="max-h-40 object-contain " alt="Preview" />
            )}
            <button
                type="button"
                onClick={onSubmit}
