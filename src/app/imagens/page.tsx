...
export default function PaginaImagens() {
    ...
    // Preencher a grid pra manter o layout consistente
    const emptySlots = hasMore ? 0 : ITEMS_PER_PAGE - (imagens.length % ITEMS_PER_PAGE || ITEMS_PER_PAGE);

    // Função pra fechar modal ao clicar no fundo
        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {Array.from({ length: emptySlots }).map((_, i) => (
                    <div
                        key={`empty-${i}`} // Mantém prefixo empty-
